...
const NotifyCreateDialogComponent = (props) => {
    ...
    const validate = () => {
        ...
        const error = {};
            ...
            if (_.isEmpty(_entity?.Pengajur)) {
                error["Pengajur"] = `Pengajur field is required`;
                ret = false;
            }
...
<div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
                ...
                <InputText id="Pengajur" className="w-full mb-3 p-inputtext-sm" value={_entity?.Pengajur} onChange={(e) => setValByKey("Pengajur", e.target.value)}  required  />
            </span>
            <small className="p-error">
